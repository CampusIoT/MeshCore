/* GENERATED by variants/xiao_nrf54l15/tools/gen_cfb_font.py — do not edit by hand.
 * Source: Adafruit-GFX-Library glcdfont.c (classic 5x7, BSD). A 6x8 MONO_VPACKED CFB
 * font (5 data columns + 1 spacing) so the ui-tiny UITask renders at its designed size. */
#include <zephyr/display/cfb.h>

static const uint8_t cfb_font_0608[95][6] = {
...
FONT_ENTRY_DEFINE(font0608, 6, 8, CFB_FONT_MONO_VPACKED, cfb_font_0608, 32, 126);
